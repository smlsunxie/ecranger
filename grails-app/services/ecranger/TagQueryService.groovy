...
class TagQueryService {
    ...
    def getUniTag ={ params ->
        ...
        if(params.group.toString() == ecranger.TagGroup.RECENT.toString()){

                partIds = params.recentPartIds

        }else if(params.group.toString() == ecranger.TagGroup.CUSTOMIZED.toString()){
        ...
        }else if(params.group.toString() == ecranger.TagGroup.UNIVERSAL.toString()){
    ...
    def getCurrentUserPartsWithTag = { params ->
        ...
        if(params.tag){
            ...
            parts = Part.findAllByTagWithCriteria(params.tag) {
                ...
                if(params.group.toString() == ecranger.TagGroup.CUSTOMIZED.toString()){
                    if(userService.isOperator() || userService.isManerger()){
                ...
                }else if(params.group.toString() == ecranger.TagGroup.RECENT.toString()){
