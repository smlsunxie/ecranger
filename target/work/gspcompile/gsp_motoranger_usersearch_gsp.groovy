...
class gsp_motoranger_usersearch_gsp extends GroovyPage {
...
invokeTag('link','g',90,['action':("edit"),'id':(user.id)],4)
printHtmlPart(22)
...
invokeTag('link','g',96,['url':("${request.contextPath}/j_spring_security_switch_user?j_username=${user.username}")],4)
printHtmlPart(25)
i++
}
}
printHtmlPart(26)
invokeTag('paginate','g',105,['total':(totalCount),'params':(queryParams)],-1)
printHtmlPart(27)
invokeTag('paginationSummary','s2ui',109,['total':(totalCount)],-1)
printHtmlPart(28)
}
printHtmlPart(29)
expressionOut.print(createLink(action: 'ajaxUserSearch'))
printHtmlPart(30)
invokeTag('initCheckboxes','s2ui',125,[:],-1)
printHtmlPart(31)
})
