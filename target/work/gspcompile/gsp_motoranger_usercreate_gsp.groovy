...
class gsp_motoranger_usercreate_gsp extends GroovyPage {
...
createTagBody(1, {->
printHtmlPart(1)
invokeTag('render','g',11,['template':("/component/formCreate"),'model':([domainName: 'user', , domain: userInstance])],-1)
printHtmlPart(2)
})
...
public static final long LAST_MODIFIED = 1391089637000L
