...
class gsp_motoranger_brandcreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/brand/create.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(1, {->
printHtmlPart(1)
invokeTag('render','g',11,['template':("/component/formCreate"),'model':([domainName: 'brand', domain: brandInstance])],-1)
printHtmlPart(2)
})
