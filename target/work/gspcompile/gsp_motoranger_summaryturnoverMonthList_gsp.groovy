...
class gsp_motoranger_summaryturnoverMonthList_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/summary/turnoverMonthList.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(6)
expressionOut.print(result.month)
printHtmlPart(6)
