...
class gsp_motoranger_roleedit_gsp extends GroovyPage {
...
printHtmlPart(1)
invokeTag('set','g',6,['var':("entityName"),'value':(message(code: 'roleInstance.label', default: 'roleInstance'))],-1)
printHtmlPart(1)
createTagBody(2, {->
createTagBody(3, {->
...
createTagBody(1, {->
printHtmlPart(1)
invokeTag('render','g',11,['template':("/component/formEdit"),'model':([domainName: 'role', domain: roleInstance])],-1)
printHtmlPart(2)
})
