...
class gsp_motoranger_productedit_gsp extends GroovyPage {
...
createTagBody(1, {->
printHtmlPart(1)
invokeTag('render','g',11,['template':("/component/formEdit"),'model':([domainName: 'product', domain: productInstance])],-1)
printHtmlPart(2)
})
