...
class gsp_motoranger_eventcreate_gsp extends GroovyPage {
...
createTagBody(1, {->
printHtmlPart(1)
invokeTag('render','g',11,['template':("/component/formCreate"),'model':([domainName: 'event', domain: eventInstance])],-1)
printHtmlPart(2)
})
...
public static final long LAST_MODIFIED = 1392107388000L
